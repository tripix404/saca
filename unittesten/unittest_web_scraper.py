...
sys.path.append(
    os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "web_scraper"))
)
...
class TestWebScraper(unittest.TestCase):
    ...
    def test_webscraper_init(self, mock_makedirs):
        scraper = web_scraper.WebScraper(
            start_url="https://www.example.com", download_html=True, download_text=True
        )
    ...
    def test_download_file(self, mock_file, mock_get):
        ...
        scraper = web_scraper.WebScraper(
            "https://www.example.com", download_images=True
        )
