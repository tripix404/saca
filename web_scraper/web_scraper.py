...
""")
    ...
    while True:
        ...
        if all_pages in ("", "y", "yes"):
            ...
            try:
                max_pages = int(input("Hoeveel pagina's wil je maximaal downloaden? [100]: ").strip() or "100")
                break
            except ValueError:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--all', action='store_true', help='Download alle bestandstypen')
    parser.add_argument('--pattern', help='Zoekpatroon in content')
    parser.add_argument('--max-pages', type=int, default=100, help='Maximaal aantal pagina\'s')
